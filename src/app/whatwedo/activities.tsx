...
const Arrow: React.FC = () => (
    <svg className="hidden lg:block absolute top-1/2 left-0 w-full" height="40" viewBox="0 0 1000 40" preserveAspectRatio="none">
        <path d="M0,20 Q250,40 500,20 T1000,20" fill="none" stroke="#E5E7EB" strokeWidth="2" strokeDasharray="8,8" />
    </svg>
);
