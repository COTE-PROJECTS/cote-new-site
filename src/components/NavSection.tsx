...
//     { name: 'HOME', href: 'https://www.unwantedwitness.org/' },
//     {
//         name: 'ABOUT',
//         href: 'https://www.unwantedwitness.org/about/',
//         children: [
...
//         ]
//     },
//     { name: 'EVENTS', href: 'https://www.unwantedwitness.org/eventspage/' },
//     { name: 'RESOURCES', href: 'https://www.unwantedwitness.org/resources/' },
//     { name: 'INSIGHTS', href: 'https://www.unwantedwitness.org/insights/' }
// ];

// const DropdownMenu: React.FC<{ items: MenuItem[], depth?: number }> = ({ items, depth = 0 }) => {
//     return (
//         <ul className={`absolute left-0 mt-2 space-y-2 bg-white shadow-md rounded-md p-2 ${depth > 0 ? 'top-0 left-full' : 'top-full'}`}>
//             {items.map((item, index) => (
//                 <li key={index} className="relative group">
//                     <a href={item.href} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 rounded-md">
//                         {item.name}
//                     </a>
//                     {item.children && (
...
//     return (
//         <div>
//             <header className={`fixed top-0 left-0 right-0 transition-all duration-300 ${isScrolled ? 'bg-white shadow-md' : 'bg-transparent'}`}>
//                 <nav className="container mx-auto px-4 py-4">
//                     <div className="flex justify-between items-center">
//                         <div className="flex items-center">
//                             <Image src="/api/placeholder/50/50" alt="Logo" width={50} height={50} />
//                             <span className="ml-2 text-xl font-bold">Unwanted Witness</span>
//                         </div>
//                         {/* Desktop Menu */}
...
//             >
//                 <div
//                     className={`fixed inset-y-0 left-0 w-64 bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${isDrawerOpen ? 'translate-x-0' : '-translate-x-full'}`}
//                 >
//                     <div className="p-6">
...
const NavSection: React.FC = () => {
    ...
    return (
        <div>
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled ? 'bg-white' : 'bg-white bg-opacity-90'}`}>
                <nav className="container mx-auto px-4 py-4">
                    <div className="flex justify-between items-center">
                        <div className="flex items-center">
                            <Image src="/api/placeholder/50/50" alt="Logo" width={50} height={50} />
