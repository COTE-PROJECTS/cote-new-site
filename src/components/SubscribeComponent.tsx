...
const SubscriptionComponent: React.FC = () => {
    return (
        <section
            className="py-16 bg-cover bg-center flex items-center justify-center"
            style={{
                backgroundImage: 'url("https://www.unwantedwitness.org/wp-content/uploads/2023/07/NewsletterBlack.png")', // Update the path to your background image
            }}
        >
            <div className="max-w-4xl mx-auto w-full px-4 md:px-8">
                ...
                <div className="mt-8 flex flex-col items-center">
                    <form
                        className="w-full md:w-auto flex flex-col md:flex-row items-center justify-center gap-4"
                        method="post"
                        action="/"
                    >
                        <input
                            type="email"
                            className="w-full md:w-96 px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:border-gray-500 text-gray-900"
                            placeholder="Email Address"
                            required
                        />
                        <button
                            type="submit"
                            className="w-full md:w-auto bg-[#004b93] text-white font-semibold py-3 px-8 rounded hover:bg-opacity-90 transition duration-300"
                        >
                            Submit
                        </button>
                    </form>
